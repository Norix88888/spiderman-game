...
(function () {
  ...
  var TORSO = [
    ...
    [1.478, 0.158, 0.098, -0.006, 2.4, 0],  // 승모근 경사
    [1.512, 0.112, 0.088, -0.006, 2.3, 0],
    [1.542, 0.078, 0.074, -0.004, 2.2, 0],  // 목 시작 (목을 짧게)
    [1.566, 0.066, 0.063, 0.000, 2.2, 0],
    [1.590, 0.065, 0.063, 0.002, 2.2, 0],
    // --- 두개골: 눈높이까지 넓히고, 정수리 직전까지 폭을 유지해야 사람 머리가 된다 ---
    [1.612, 0.062, 0.074, 0.014, 2.3, 0],      // 턱끝
    [1.640, 0.076, 0.091, 0.011, 2.4, 0.004],  // 턱선
    [1.668, 0.086, 0.099, 0.005, 2.4, 0.013],  // 입
    [1.700, 0.093, 0.104, -0.002, 2.5, 0.021], // 광대 + 코
    [1.732, 0.096, 0.105, -0.008, 2.6, 0.016], // 눈 (최대폭)
    [1.762, 0.095, 0.102, -0.013, 2.6, 0.005], // 눈썹뼈
    [1.790, 0.092, 0.097, -0.017, 2.6, 0],     // 이마
    [1.816, 0.086, 0.089, -0.019, 2.5, 0],     // 두정부 (아직 넓게)
    [1.838, 0.072, 0.074, -0.019, 2.4, 0],     // 정수리 곡면 시작
    [1.854, 0.048, 0.050, -0.017, 2.3, 0],
    [1.864, 0.022, 0.023, -0.015, 2.2, 0]      // 정수리
  ];
